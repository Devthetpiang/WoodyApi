...
public class OnboardingFragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        TextView tvTitle = (TextView)v.findViewById(R.id.tvTour5Title);
        TextView tvMsg = (TextView)v.findViewById(R.id.tvTour5Msg);
        ...
        if (AppValues.getInstance().getZawGyiDisplay()) {
            tvTitle.setText(getResources().getString(R.string.tour_5_title_zg));
            tvMsg.setText(getResources().getString(R.string.tour_5_msg_zg));
        } else {
            tvTitle.setText(getResources().getString(R.string.tour_5_title));
            tvMsg.setText(getResources().getString(R.string.tour_5_msg));
        }
